...
INSERT INTO `configs` VALUES (1,NULL,NULL,'weather',NULL,'',0,NULL,'C:\\Users\\voduc\\Data_Weather',0);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_status_logs`(in config_id int, in stt VARCHAR(45),in des VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_status_configs`(in config_id int,in stt varchar(45))
BEGIN
